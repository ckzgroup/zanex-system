...
import {DataTable} from "@/components/tables/services/services/data-table";
import {columns} from "@/components/tables/services/services/column";
...
function ServicesPage() {
    ...
    const { isLoading, error, data } = useFetchData('/services');
        ...
        <div>
            <div className='flex flex-col md:flex-row justify-between gap-6  mb-8'>
                <div>
                    ...
                    <p className='text-muted-foreground'> View and manage all your services </p>
                </div>
                    ...
                    <Sheet>
                        ...
                        <SheetContent>
                            <SheetHeader>
                                ...
                                <SheetDescription>
                                    Use the form below to add a new service to the system.
                                </SheetDescription>
                            </SheetHeader>
                            <div className="mt-6">
                                <AddServiceForm />
