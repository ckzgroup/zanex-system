...
function MaterialReport() {
  ...
  async function onSubmit(data: FormData) {
    try {
      ...
      const url = `https://k-task.ckzgroup.com/upload/fpdf/generate/technician_material_report.php?${queryParams}`;
      ...
      link.href = blobUrl;
      link.setAttribute("download", "Technicians_Material_Report.pdf"); // Set the file name
