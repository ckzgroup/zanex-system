...
function RegionalCausesReport() {
  ...
  const pdf =
    process.env.NEXT_PUBLIC_IMAGES + "/fpdf/generate/fault_causes_region.php";
  ...
  async function onSubmit(data: FormData) {
    try {
      ...
      const url = `https://k-task.ckzgroup.com/upload/fpdf/generate/fault_causes_region.php?${queryParams}`;
      ...
      if (response.status === 200) {
        ...
        toast({
          ...
          description:
            "You have successfully generated regional fault causes analysis report.",
          variant: "default",
        });
      } else {
