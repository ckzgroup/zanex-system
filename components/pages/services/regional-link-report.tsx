...
function RegionalLinkReport() {
  ...
  const {
    ...
    error: slaError,
    data: slaData,
  } = useSingleCustomer("/ticketing", parseInt(selectedCustomerId || "0"));
  ...
  async function onSubmit(data: FormData) {
    try {
      ...
      const url = `https://k-task.ckzgroup.com/upload/fpdf/generate/link_reports.php?${queryParams}`;
                  ...
                  <Select onValueChange={field.onChange}>
                    <FormControl>
                      {slas.length > 0 ? (
                        ...
                        <SelectTrigger>
                          <SelectValue placeholder="Add SLA for the selected customer" />
                        </SelectTrigger>
                      )}
                    </FormControl>
                    <SelectContent>
