...
function FilteredSegmentReport() {
  ...
  async function onSubmit(data: FormData) {
    try {
      ...
      const url = `https://k-task.ckzgroup.com/upload/fpdf/generate/segment_scope_report.php?${queryParams}`;
      ...
      if (response.status === 200) {
        ...
        toast({
          ...
          description:
            "You have successfully generated the monthly segment report.",
          variant: "default",
        });
      } else {
