...
const reAssignSchema = z.object({
    ...
    re_assign_reason: z.string().nonempty(),
    date: z.any(),
...
type FormData = z.infer<typeof reAssignSchema>

interface IProps {
    ticketId: any
}
function ReAssignTicketForm({ ticketId }: IProps) {
...
// Combine static and dynamic options
    ...
    const mutation = usePostData('/maintenance/reAssignTicket');
    ...
    async function onSubmit(data: FormData) {
        try {
            ...
            toast({
                ...
                description: "You have successfully re-assigned a ticket.",
                variant: "default"
            });
                    ...
                    <div
                        ...
                        <div className="grid gap-1">
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        <FormLabel> Re-Assign Note </FormLabel>
                                        <FormControl>
